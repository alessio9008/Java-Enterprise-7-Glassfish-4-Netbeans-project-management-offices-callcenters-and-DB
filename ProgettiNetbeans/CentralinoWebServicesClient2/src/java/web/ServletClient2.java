...
import webservices.WebServicesClient2_Service;



/**
 *Servlet che serve per gestire i clienti di tipo 2
 * @author Alessio_Gregory_Ricky
 */
@WebServlet(name = "ServletClient2", urlPatterns = {"/ServletClient2"})
public class ServletClient2 extends HttpServlet {
    /**
     * Riferimento al web services
     */
    @WebServiceRef(wsdlLocation = "WEB-INF/wsdl/localhost_8080/CentralinoWebServices2/WebServicesClient2.wsdl")
    private WebServicesClient2_Service service;
    /**
...
//                    System.err.println("STATUS: " + status);
            ...
            sleep(2000);
            receiveMessage("2" + activity.getId(), out);
    ...
    private void addActivity(webservices.Activity activity) {
        ...
        webservices.WebServicesClient2 port = service.getWebServicesClient2Port();
